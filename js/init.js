...
function arlo_tm_animate_text(){
	...
	var animateSpan			= jQuery('.arlo_tm_animation_text_word');
		...
		animateSpan.typed({
			strings: ["Data Engineer by profession", "Programmer at work", "Problem - Solver by passion", "Tech-Enthusiasts by interests", "Dreamer by ambition", "Poet/Writer during leisure"],
			loop: true,
			startDelay: 1e3,
			backDelay: 2e3
		});
